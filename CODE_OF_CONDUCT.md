...
[private GitHub security advisory](https://github.com/epaprat/albion-ledger/security/advisories/new)
or by contacting the maintainer. All complaints will be reviewed and investigated
promptly and fairly.
...
1. **Correction** — a private, written warning for unprofessional or unwelcome
   behavior.
2. **Warning** — consequences for a single incident or series of actions, with
